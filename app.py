...
os.makedirs(CHROMA_DIR, exist_ok=True, mode=0o777)
...
vectorstore = Chroma(
    ...
    collection_metadata={"hnsw:space": "cosine", "hnsw:M": 8, "hnsw:ef_construction": 50}
)
...
async def upload_file(file: UploadFile = File(...)):
    try:
        ...
        splitter = TokenTextSplitter(chunk_size=64, chunk_overlap=10, add_start_index=True)
